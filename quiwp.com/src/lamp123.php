<?php	
	...
	echo "\n\n";
	echo log("MYSQL Succesfully Installed...", "SUCCESS");
	echo "\n\n";		
	...
	echo "\n\n";
	echo log("Apache Succesfully Installed...", "SUCCESS");
	echo "\n\n";
	echo "**************Creating Database********************** \n\n";	
	system('mysql -u root -p"mysql" < ~/mydata.sql');
	echo "\n\n";
	echo log("Your Database Has abeen Successfully Created...!", "SUCCESS");
	echo "\n\n";
